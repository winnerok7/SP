...
.data
	Capt db "Butsev Bohdan IV-81 task: 46!" ,0
	Capt1 db "Task #2: 46! x 46!" ,0
	Capttest1 db "task #3 N*N (111..1*111..1)" ,0
	Capttest2 db "task #4 N*32 (111..1*111..1)" ,0
	Capttest3 db "task #5 N*N (111..1*11..100..0)" ,0
	textBuf dd 100 dup(?)
	textBuf1 dd 100 dup(?)
